    ...
    return (
      <div>
        <div className={styles.container} style={{flexDirection:"row", marginLeft:"15%"}}>
          ...
          <p style={{color:"grey", fontStyle:"italic"}}>We don’t know the actual number of COVID–19 cases, deaths & recoveries, just those that have been officially reported. Please view the visualizations with that in mind.</p>
        </div>
